...
namespace Northwind.DAL
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int SP_UpdateCategory(string categoryname, string description, Nullable<int> categoryid)
        {
            var categorynameParameter = categoryname != null ?
                new ObjectParameter("categoryname", categoryname) :
                new ObjectParameter("categoryname", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_UpdateCategory", categorynameParameter, descriptionParameter, categoryidParameter);
        }
    
        public virtual int SP_UpdateProduct(string productname, Nullable<int> supplierId, Nullable<int> categoryid, string quantityperunit, Nullable<decimal> unitprice, Nullable<short> unitinstock, Nullable<short> unitsonorder, Nullable<short> reorderlevel, Nullable<bool> discontinued, Nullable<int> productid)
        {
            ...
            var unitinstockParameter = unitinstock.HasValue ?
                ...
                new ObjectParameter("unitinstock", typeof(short));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_UpdateProduct", productnameParameter, supplierIdParameter, categoryidParameter, quantityperunitParameter, unitpriceParameter, unitinstockParameter, unitsonorderParameter, reorderlevelParameter, discontinuedParameter, productidParameter);
        }
